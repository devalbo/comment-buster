...
// import { WorkspaceCommentSectionsFinder } from './WorkspaceCommentSectionsFinder';
...
// export class CommentBusterTreeDataProvider implements vscode.TreeDataProvider<{ key: string }> {
...
//     const commentSectionResults = await commentSectionsFinder.findCommentSections(TypeScriptLanguageConfiguration);
